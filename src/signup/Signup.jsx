    ...
    return (
        <>
            <div className='bg-gray-50 min-h-full'>
                <div className="border-b border-gray-300 pb-4 mb-4 h-45 flex-col justify-between items-center pt-10">
                <h1 className="text-3xl font-bold text-gray-800 mb-1 flex justify-center font-Kantumruy">បង្កើតគណនី</h1>
                    <h2 className="text-lg font-semibold text-gray-700 flex justify-center ">NEAKWATCH REWARDS</h2>
                    <p className='text-xl text-gray-600 flex justify-center'>Join NaekWatch Rewards to earn points for special gift, a birthday Reward and more.</p>
                    <p className="text-xl text-gray-600 flex justify-center font-Kantumruy">បង្កើតគណនី NaekWatch ដើម្បីទទួលបានពិន្ទុក្នុងការចាប់រង្វាន់ពិសេសៗ រួមទាំងរង្វាន់សម្រាប់ថ្ងៃខួបកំណើត និងរង្វាន់ផ្សេងៗទៀត</p>
                </div>
                <main className="min-h-screen bg-gray-50 py-8 px-4 flex justify-center font-sans">
                    <div className="max-w-2xl w-full bg-white shadow-md border border-gray-200 p-6 md:p-8">
                        ...
                        <div className="mb-4 font-Kantumruy text-xl">
                            ...
                            <input
                                ...
                                className="w-full p-2 border border-gray-300 rounded-sm focus:outline-none focus:ring-1 focus:ring-gray-400 focus:border-gray-400 bg-white"
                            />
                        </div>
                        <div className="mb-4 font-Kantumruy text-xl">
                            <input
                        ...
                        <div className="mb-4 font-Kantumruy">
                            <p className="text-xl text-gray-800 mb-1 font-semibold">អ៊ីមែល ឬ លេខទូរស័ព្ទ</p>
                            <input
                                type="text"
                                placeholder="អ៊ីមែល ឬ លេខទូរស័ព្ទ"
                                className="w-full p-2 border border-gray-300 rounded-sm focus:outline-none focus:ring-1 focus:ring-gray-400 focus:border-gray-400 bg-white text-xl"
                            />
                        </div>
                        <div className="mb-4 font-Kantumruy text-xl">
                            <p className="text-xl text-gray-800 mb-1 font-semibold">ពាក្យសម្ងាត់</p>
                            <input
                                type="password"
                        ...
                        <div className="mb-6 font-Kantumruy text-xl">
                            <p className="text-xl text-gray-800 mb-1 font-semibold">បញ្ជាក់ពាក្យសម្ងាត់</p>
                            <input
                                type="password"
                        ...
                        <div className="bg-gray-100 border-gray-600 p-4 mb-5 text-[15px] text-gray-800">
                            <p>
                        ...
                        <div className="flex items-start mb-6">
                            ...
                            />
                            <label htmlFor="terms" className="text-[15px] text-gray-700 leading-tight">
