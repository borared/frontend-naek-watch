            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div className="space-y-6">
                    <div className="inline-block px-4 py-2 bg-red-600/10 border border-red-600/20 rounded-full mb-4">
                        <span className="text-red-500 text-sm font-semibold uppercase tracking-wider font-Kantumruy">រឿងរ៉ាវរបស់យើង • Our Story</span>
                    </div>
                    ...
                    <div className="relative bg-zinc-900/50 border border-white/10 rounded-3xl p-8 backdrop-blur-sm">
                        <div className="space-y-6">
                            <div className="flex items-start gap-4 group">
                                <div className="flex-shrink-0 w-12 h-12 bg-red-600/10 border border-red-600/20 rounded-xl flex items-center justify-center group-hover:bg-red-600/20 transition-colors">
