const movies = [
	{
		...
		image: "https://i.redd.it/j7o826q9j5x81.jpg",
		year: "1988",
		rating: "8.0",
		duration: "2h 04m",
		synopsis:
			"In a dystopian Neo-Tokyo, a secret military project turns a biker gang member into a rampaging psionic psychopath who can only be stopped by his best friend.",
		accent: "bg-red-600",
	},
...

	{
		...
		duration: "1h 58m",
		synopsis:
			"In a world of legendary heroes, four low-ranking 'nobody' demons—a pig, a toad, a weasel, and a gorilla—decide to impersonate the famous pilgrims from Journey to the West to find their own purpose and escape their mundane lives.",
	...
	// Trending Only Movies
	{
		...
		image: "https://cdn.marvel.com/content/1x/across_the_spider-verse.jpg",
		categories: ["trending"],
	},
	{
		id: 102,
	...
	},
	{
		...
		type: "movie",
		image:
			"https://i.ebayimg.com/00/s/MTYwMFgxMDY2/z/SRgAAOSwXY9kNpU~/$_57.JPG?set_id=8800005007",
		categories: ["trending"],
	},
	{
		id: 104,
	...
	},
	{
		...
		duration: "2h 50m",
		synopsis:
			"Two friends embark on a quest for a lost buddy. On this journey, they encounter a long forgotten bet, a wedding they must crash, and a funeral that goes impossibly out of control, as they recall their college days with the free-spirited Rancho.",
		accent: "bg-yellow-500",
	},
	...
	},
	{
		...
		image:
			"https://preview.redd.it/just-made-this-concept-poster-for-spider-man-brand-new-day-v0-svwcepqv2nhf1.jpeg?auto=webp&s=a10f9a661b70bd0d1563bd20f1017290c54eed5f",
		trailer: "https://www.youtube.com/watch?v=aBlsrtxuwss",
		categories: ["upcoming"],
	...
	},
	{
		...
		title: "Supergirl",
		image:
			"https://m.media-amazon.com/images/M/MV5BZmYzN2VhNTAtYWUxZi00OTNiLWIyZDgtMGMxZTNlYzM3ZmE1XkEyXkFqcGc@._V1_.jpg",
		videoUrl: "https://www.youtube.com/watch?v=YqdAEdkHrwo",
		trailer: "https://www.youtube.com/watch?v=YqdAEdkHrwo",
        categories: ["upcoming"],
	},
	{
		id: 1004,
		...
		image:
			"https://preview.redd.it/official-poster-for-project-hail-mary-starring-ryan-gosling-v0-l0fgrigwwg9f1.jpeg?auto=webp&s=720c32d237547ffc3f5d64b2b38b2956aa261e70",
		trailer: "https://www.youtube.com/watch?v=P0XN3-n-2Lo",
        categories: ["upcoming"],
	},
	{
    id: 1005,
    ...
    tagline: "THE PRICE OF PROPHECY",
    videoUrl: "https://www.youtube.com/watch?v=3_9vCamtuPY",
    trailerUrl: "https://www.youtube.com/watch?v=3_9vCamtuPY",
    poster: "https://cdn.kinocheck.com/i/ad3cls7zcg.jpg",
    backdrop: "https://images.unsplash.com/photo-1509316785289-025f5b846b35?auto=format&fit=crop&w=1400&q=80",
    image: "https://cdn.kinocheck.com/i/ad3cls7zcg.jpg",
    year: "2026",
    rating: "Pending",
    duration: "2h 45m (Expected)",
    synopsis: "Twelve years after his conquest of Arrakis, Paul Atreides rules as Emperor. As a galaxy-wide jihad rages in his name, Paul must navigate a deadly conspiracy led by the Bene Gesserit, the Tleilaxu, and his own wife, Princess Irulan, while struggling to save the woman he loves and the future of humanity.",
    accent: "bg-stone-950",
    cast: [
        { name: "Timothée Chalamet", role: "Paul Atreides" },
        { name: "Zendaya", role: "Chani" },
        { name: "Florence Pugh", role: "Princess Irulan" },
        { name: "Robert Pattinson", role: "Scytale" },
        { name: "Anya Taylor-Joy", role: "Alia Atreides" },
        { name: "Jason Momoa", role: "Hayt / Duncan Idaho" }
    ]
    },
